    ...
    it('should map contiguous arc segments', () => {
      const shape: Plotter.Shape = {
        ...
        segments: [
          {
            type: Plotter.ARC,
            start: [0, 0, 3.1415926536],
            end: [0.25, 0.25, 1.5707963268],
            center: [0.25, 0],
            radius: 0.25,
            sweep: 1.5707963268,
          ...
          {
            type: Plotter.ARC,
            start: [0.5, 0.5, 3.1415926536],
            end: [0.75, 0.25, -1.5707963268],
            center: [0.75, 0.5],
            radius: 0.25,
            sweep: 4.7123889804,
            direction: Plotter.CW,
          ...
          {
            type: Plotter.ARC,
            start: [0.75, 0.25, 1.5707963268],
            end: [1, 0, 6.2831853072],
            center: [0.75, 0],
            radius: 0.25,
            sweep: 4.7123889804,
            direction: Plotter.CCW,
